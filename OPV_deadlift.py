#Python code for running posture detection and correction for the exercise of Deadlift
...
input_source = "deadlift.mp4"   #change name for required video to be analyzed
...
for i in range(0,len(a)):   #this loop is responsible for marking the lowest points of the hip angles in the video to be checked
    ...
    if(h1[i]>h1_mean):
        if(c1>10):
            ...
            #print(x1,x2)
        c1=0 
print("Frames to check the deadlifts=",x)
for i in x: #once the required lowest frames and determined the angle at these points is to be checked and provide correction
    ...
    if((a12_m<=10 or a15_m<=10) and (70<=a23_m<=95 or 70<=a56_m<=95)):  #the anlge of the hip is checked for beingin the required range to be classified as a good deadlift
        print("Good Deadlift")
        if (a12_m<=a15_m): #once determined that it is a good deadlift, other factors of the posture are checked like the back angles
            print("Just",a12_m," degrees for a perfectly straight back")
        else:
            print("Just",a15_m," degrees for a perfectly straight back")
        if (70<=a23_m<=95):
        ...
        if (a34_m<=a67_m):
            print("Knee bent by {} degrees".format(abs(180-a34_m)))
        else:
            print("Knee bent by {} degrees".format(abs(180-a67_m)))
    else:
        print("Bad Deadlift")   #if determined as a bad deadlift, the factors contributing to that are mentioned and required corrections are provided
        ...
        if (a12_m<=a15_m):
            ...
            print("Just",a15_m," degrees for a perfectly straight back")
        if ((a23_m>95 or a23_m<70) and (a56_m>95 or a56_m<70)):
            print("Maintain the hip angle below 90 degrees")
            if (a23_m>95 and a56_m>95):
                print("Bend the torso a little more")
            if (a23_m<70 and a56_m<70):
